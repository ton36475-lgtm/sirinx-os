...
- GitHub `main` is at `e91d4b3 fix: restore global live energy background`.
- PR #1 is merged. It is no longer a release blocker.
- Public website production is deployed on Cloudflare Pages as `c4fec2bc`, branch `main`, source `e91d4b3`, URL `https://c4fec2bc.sirinx-co.pages.dev`.
